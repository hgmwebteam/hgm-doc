...
export default async (req: Request) => {
    ...
    try {
        ...
        // ONE RULE FOR EVERYONE: the person who raised it may withdraw it. A
        // colleague on the same dashboard may not, and a staff member may not
        // withdraw a client's - but a staff member who raised a ticket for a
        // client is its raiser and may. The ownership test below decides that
        // by design now, not by accident: submitted_by is who raised it,
        // whoever they were.
